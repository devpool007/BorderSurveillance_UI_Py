...
start = tk.Button(root,text=" Start ",font=("Courier", 20),bg="#54625B",command=lambda:start_func())
start.place(relx=0.5,rely=0.82,relwidth=0.5,relheight=0.05,anchor='n')
